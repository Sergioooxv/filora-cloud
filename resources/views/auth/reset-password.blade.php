            ...
            <div class="col-lg-4 col-md-6 col-sm 8">
                ...
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <h3 class="text-display">Actualizar tu contraseña</h3>
                        <p class="auth-subtitle">Actualiza la contraseña de tu cuenta</p>
                    </div>
                    ...
                    <div class="form-container">
                        <form action="/reset-contrasena" class="login-form" method="POST">
                            ...
                            <div class="mb-3">
                                <label class="form-label auth-label">Nueva Contraseña</label>
                            ...
                            <button type="button" class="btn auth-btn w-100">Actualizar contraseña</button>
                        </form>
                    </div>
